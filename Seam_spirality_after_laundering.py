...
def seam_test_template(doc,test_name,test_method,remarks,title,values,req):
    ...
    for table_index in range(num_tables):
        ...
        table.cell(1, column_index).text = req[0]
        table.cell(2, column_index).text = req[1]
...
def seam_test_data():
    title = ['Sample','Spirality (%)','Spirality (cm)']
    ...
    test_name = "Seam spirality after laundering:"
    test_method = "ISO 16322-3:2021"
    remarks = ""
