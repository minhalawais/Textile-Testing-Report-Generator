...
def Cadmium_test_template(doc,test_name,test_method,remarks,values,req):
    ...
    for table_index in range(num_tables):
        ...
        table.cell(1, 0).text = 'Cadmium (Cd)'
        table.cell(0, 1).text = "CAS No"
        table.cell(1, 1).text = '7440-43-9'
...
def Cadmium_test_data():
    ...
    test_name = "Total Cadmium (Cd) Content:"
