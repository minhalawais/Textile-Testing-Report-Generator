...
def Quinoline_test_template(doc,test_name,test_method,remarks,values,req):
    ...
    for table_index in range(num_tables):
        ...
        table.cell(1, 0).text = 'Quinoline'
        table.cell(0, 1).text = "CAS No"
        table.cell(1, 1).text = '91-22-5'
    ...
    table.cell(1,0).text = "MDL: 15 mg/kg"

    widths = (Inches(10), Inches(2))
    set_col_widths(table, widths)

def Quinoline_test_data():
