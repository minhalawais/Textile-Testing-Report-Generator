...
def Formaldehyde_test_template(doc,test_name,test_method,remarks,values,req):
    ...
    for table_index in range(num_tables):
        ...
        table.cell(1, 0).text = 'Formaldehyde'
    ...
    table.style = 'Table Grid'
    table.cell(0,0).text ="MDL: 16 mg/kg"
    table.cell(1,0).text = "MDL: Method detection limit"
    table.cell(2,0).text = "ND: Not detected"
    table.cell(3,0).text = "mg/kg: milligram per kilogram"
    widths = (Inches(10), Inches(2))
    set_col_widths(table, widths)


def Formaldehyde_test_data():
    ...
    test_name = "Formaldehyde:"
    test_method = "DIN EN ISO 14184-1:2011"
    remarks = ""
